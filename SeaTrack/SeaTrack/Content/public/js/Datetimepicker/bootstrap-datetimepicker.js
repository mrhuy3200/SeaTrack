...
(function(factory){
  ...
  var Datetimepicker = function (element, options) {
    ...
    this.component = this.element.is('.date') ? ( this.bootcssVer === 3 ? this.element.find('.input-group-text .glyphicon-th, .input-group-text .glyphicon-time, .input-group-text .glyphicon-remove, .input-group-text .glyphicon-calendar, .input-group-text .fa-calendar, .input-group-text .fa-clock').parent() : this.element.find('.add-on .icon-th, .add-on .icon-time, .add-on .icon-calendar, .add-on .fa-calendar, .add-on .fa-clock').parent()) : false;
